            ...
            <div className="bg-white rounded-lg p-3 border border-gray-200">
              ...
              <p className="font-medium text-gray-900">
                ...
                {request.estimateAmount
                  ? Number(request.estimateAmount).toLocaleString()
                  : "Not specified"}
              </p>
            </div>
            <div className="bg-white rounded-lg p-3 border border-gray-200">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="mb-6">
            ...
            <p className="mt-1 text-xs text-gray-500">
              {action === "approve"
                ? "Optional comments help track approval decisions"
                : "Required to help the requester understand the decision"}
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              type="submit"
              disabled={
                isSubmitting || (action !== "approve" && !reason.trim())
              }
