...
export default function ApprovalsPage() {
  ...
  const handleModalSubmit = (action: 'approve' | 'reject' | 'revision', reason?: string) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <ApprovalModal
        ...
        isSubmitting={approveMutation.isPending || rejectMutation.isPending || revisionMutation.isPending}
      />
    </div>
  );
}
