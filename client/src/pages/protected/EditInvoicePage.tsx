...
export default function EditInvoicePage() {
  ...
  const updateMut = useMutation({
    mutationFn: async () => updateInvoice(id!, {
    ...
    return (
      <div className="max-w-2xl mx-auto p-6">
        <div className="bg-red-50 border border-red-200 rounded-md p-4">
          <p className="text-red-800">You don't have permission to edit invoices.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="mb-6">
          <h3 className="text-lg font-medium text-gray-900 mb-2">Invoice Information</h3>
          <div className="text-sm text-gray-600 space-y-1">
            <p><strong>Invoice ID:</strong> {invoice.id}</p>
            <p><strong>Invoice No:</strong> {invoice.invoiceNo}</p>
            <p><strong>Request ID:</strong> {invoice.requestId}</p>
            <p><strong>Current Status:</strong> 
              <span className={`ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                ...
                invoice.status === 'APPROVED_FOR_PAYMENT' ? 'bg-green-100 text-green-800' :
        ...
        <form onSubmit={e => { e.preventDefault(); updateMut.mutate(); }} className="space-y-4">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <p className="text-xs text-blue-700 mb-3">
              <strong>Gross Amount:</strong> The base amount before taxes or fees<br/>
              <strong>Tax Amount:</strong> Additional taxes/fees to be added<br/>
