...
export default function ServicesPage() {
  const cateringServices = [
    ...
    },
    {
      ...
      features: ['Meeting room setup', 'Working lunch options', 'Coffee break service', 'Professional presentation'],
  ...
  const additionalServices = [
    ...
    },
    {
      ...
      description: 'Professional beverage service for all types of events and occasions.',
      features: ['Premium beverages', 'Custom drink menus', 'Non-alcoholic options', 'Professional service staff']
    },
    {
      icon: 'fas fa-truck',
      iconBg: 'from-blue-500 to-blue-600',
      title: 'Delivery & Setup',
      description: 'Reliable delivery and professional setup services for your event location.',
      features: ['On-time delivery', 'Professional setup', 'Equipment rental', 'Cleanup service']
    }
  ];
          ...
          <div className="animate-fade-in-up">
            <div className="backdrop-blur-sm bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl max-w-4xl mx-auto">
              ...
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-full px-6 py-3">
                ...
                <span className="text-white font-medium">Excellence in University Catering</span>
              </div>
            </div>
          </div>
        </div>
